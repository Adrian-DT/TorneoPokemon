...
public class Agua extends Pokemon {
	...
	public Agua(String nombre, String tipo, int vida, int puntosMagia, boolean evolucionado) {
		super(nombre, tipo = "agua", vida, puntosMagia);
	...
	public String ataqueEspecial(Pokemon pokemon) {
		...
		if (getPuntosMagia() % 5 == 0) {
			...
			return getNombre() + " ha realizado el ataque especial 'chorro de agua' a " + pokemon.getNombre();
		}
	...
	public void evoluciona() {
		if (exp >= 3) {
			...
			System.out.println("¡¡Squirtle ha evolucionado en Wartortle!!\n");
		}
